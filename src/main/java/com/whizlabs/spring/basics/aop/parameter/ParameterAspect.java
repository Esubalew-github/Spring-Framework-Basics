...
public class ParameterAspect {
   ...
   @Around(value = "multiplyPointcut() && args(arg) && target(cal)", argNames = "jointPoint,arg,cal")
   private int preHandle(ProceedingJoinPoint joinPoint, int arg, Calculator cal) throws  Throwable{
       System.out.println("Pre-handling argument with the factor of " + cal.getFactor());
       if (arg<0){
           arg=-arg;
       }
